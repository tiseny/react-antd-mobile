...
const Register = createForm()(class Detail extends React.PureComponent {
  ...
  render() {
    ...
    return <div>
      ...
      <WhiteSpace />
      <WingBlank size="md">
        <Button type="primary" onClick={this.handleGo.bind(this, '/')}>确定</Button>
        <WhiteSpace />
        <Button type="ghost" size="small" inline style={{ float: 'left' }} onClick={this.handleGo.bind(this, '/login')}>我要登陆</Button>
